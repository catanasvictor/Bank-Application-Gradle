...
public class Constants {
    ...
    public static class Rights {
        ...
        public static final String[] RIGHTS = new String[]{CREATE_USER, DELETE_USER, UPDATE_USER, ADD_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT, UPDATE_ACCOUNT, DELETE_ACCOUNT};
    }
    ...
    public static Map<String, List<String>> getRolesRights() {
        ...
        ROLES_RIGHTS.get(EMPLOYEE).addAll(Arrays.asList(ADD_CLIENT, UPDATE_CLIENT, CREATE_ACCOUNT, UPDATE_ACCOUNT, DELETE_ACCOUNT));
